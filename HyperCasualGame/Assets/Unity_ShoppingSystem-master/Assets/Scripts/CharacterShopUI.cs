...
public class CharacterShopUI : MonoBehaviour
{
	...
	[SerializeField] Button openSettingMenuButton;
	[SerializeField] Button closeSettingMenuButton;
...
//		});
	...
	//	scrollUpButton.onClick.AddListener (OnScollUpClicked);
	    ...
	    openSettingMenuButton.onClick.RemoveAllListeners ();
		openSettingMenuButton.onClick.AddListener (OpenSettingsMenu);

		closeSettingMenuButton.onClick.RemoveAllListeners ();
		closeSettingMenuButton.onClick.AddListener (CloseSettingsMenu);
	}
	...
	void OpenShop ()
	{
		...
		CameraDoTween.instance.OnShop();
	}

	void CloseShop ()
	{
		shopUI.SetActive (false);
		CameraDoTween.instance.OffShop();
	}
